...
Viewer.prototype.renderStatements = function(statementsResult) {
    ...
    stmtStr.push("<table id='myTable' class='table table-striped'>");

    stmtStr.push("<tr><th>Time</th><th>Player`s answer</th></tr>");
    ...
    for (i = 0; i < statements.length; i++) {
        ...
        //console.log(stmt.result.response)
        //console.log(stmt.object.definition);
        try {
            stmtStr.push("<tr>" );
            ...
            stmtStr.push("<span class='actor'>"  + getActorName(stmt.actor.mbox) + "</span>");
            //getActorName(stmt.authority.name)
            ...
            stmtStr.push(" <span class='object'>'" +  stmt.result.response + "   '</span>");
